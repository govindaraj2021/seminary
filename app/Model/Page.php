...
class Page extends Model
{
    ...
    protected $fillable = ['position_id', 'parent_id', 'name', 'page_title', 'large_image', 'url', 'description', 'meta_title', 'meta_keyword', 'meta_description', 'status', 'priority', 'updated_at', 'created_by', 'modified_by'];
}
